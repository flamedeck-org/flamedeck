            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="p-6 border rounded-lg bg-card text-left space-y-3">
                ...
                <p className="text-muted-foreground">
                  Drag & drop traces, or integrate seamlessly with our <Link to='/docs/api-keys' className='underline hover:text-primary'>API</Link> & <Link to='/docs/cli-upload' className='underline hover:text-primary'>CLI</Link>. No complicated setup.
                </p>
              </div>
              <div className="p-6 border rounded-lg bg-card text-left space-y-3">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                FlameDeck combines ease of use with powerful AI to help your team ship faster, more performant applications.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 border rounded-lg bg-card text-left space-y-4 shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="text-muted-foreground text-lg">
                  No complicated setup, just drag, drop, and view! Or use our API/CLI for automated uploads. Get insights quickly, regardless of expertise.
                </p>
              </div>
              <div className="p-8 border rounded-lg bg-card text-left space-y-4 shadow-sm hover:shadow-md transition-shadow duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-10 w-10 text-primary mb-3"><path d="M9.5 14.5A2.5 2.5 0 0 1 12 12a2.5 2.5 0 0 1 2.5 2.5v0A2.5 2.5 0 0 1 12 17a2.5 2.5 0 0 1-2.5-2.5v0Z" /><path d="M12 12V6a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v0a2 2 0 0 0 2 2h2" /><path d="M12 12V2.5A1.5 1.5 0 0 1 13.5 1a1.5 1.5 0 0 1 1.5 1.5V6h-3" /><path d="M12 17v2.5a1.5 1.5 0 0 0 1.5 1.5a1.5 1.5 0 0 0 1.5-1.5V17h-3" /><path d="M8 12H2.5A1.5 1.5 0 0 0 1 13.5A1.5 1.5 0 0 0 2.5 15H8Z" /><path d="M16 12h5.5a1.5 1.5 0 0 1 1.5 1.5a1.5 1.5 0 0 1-1.5 1.5H16Z" /></svg>
                <h3 className="text-2xl font-semibold">AI-Assisted Optimization</h3>
                <p className="text-muted-foreground text-lg">
                  Performance tuning is complex. Leverage AI to automatically analyze traces, identify bottlenecks, and get actionable recommendations.
                </p>
              </div>
              <div className="p-8 border rounded-lg bg-card text-left space-y-4 shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="text-muted-foreground text-lg">
                  Easily integrate trace uploading into your CI/CD pipelines, testing frameworks, or applications using our robust <Link to='/docs/api-keys' className='underline hover:text-primary'>API</Link> and <Link to='/docs/cli-upload' className='underline hover:text-primary'>CLI tools</Link>. Explore the <Link to='/docs' className='underline hover:text-primary'>full documentation</Link>.
                </p>
              </div>
            </div>
          </div>
