...
function LoggedOutTraceViewerPage() {
  ...
  return (
    <Layout noPadding>
      <div
        className={`h-full bg-background relative transition-all duration-300 overflow-hidden ${
          uploadState.isDragging ? 'bg-primary/5' : ''
        }`}
        onDrop={handleDrop}
        ...
        {uploadState.isDragging && (
          <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-center">
            <div className="text-center p-12 bg-card/90 backdrop-blur-xl rounded-3xl border-2 border-dashed border-primary shadow-2xl max-w-md mx-4">
              ...
              <p className="text-muted-foreground">Release your trace file to start analyzing</p>
            </div>
          </div>
        )}
