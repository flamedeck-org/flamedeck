...
export function useUserApiKeys() {
    ...
    return useQuery<ApiKeyDisplayData[], ApiError>({ // Specify types for data and error
...
export function useCreateApiKey() {
    ...
    return useMutation<{
        apiKeyId: string;
        plainTextKey: string;
    }, ApiError, { description: string | null; scopes: string[] }>({ // Specify types for mutation result, error, and variables
