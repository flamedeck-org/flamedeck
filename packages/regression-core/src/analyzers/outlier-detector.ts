import type { OutlierRemovalOptions } from '../types/statistics';
...
export class OutlierDetector {
  ...
  private static trimOutliers(
    ...
    const removed = [...indexedValues.slice(0, removeCount), ...indexedValues.slice(-removeCount)];
   ...
   */
  private static removeZScoreOutliers(
    values: number[],
    threshold: number
  ): {
    cleanedValues: number[];
