...
import { type ProfileGroup, type Profile, type Frame, formatPercent } from '../../../packages/shared-importer/src/index.ts';
...
export const getTopFunctionsToolSchema = {
  ...
  function: {
    ...
    description: "Retrieves a list of the top N functions from the loaded trace profile based on their execution time...",
    parameters: {
